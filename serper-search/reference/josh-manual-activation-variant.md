...
**DO NOT auto-activate this skill.** Limited API credits - only use when Josh explicitly requests:
- "use serper"
- "serper search for..."
- "use the serper api"

**ALWAYS ASK before making Serper API calls** if unsure whether Josh wants to use credits.

## When to Use

ONLY activate this skill when Josh explicitly requests Serper. Do NOT use for:
...
**API Key Location:** `/home/josh/Josh-AI/.env` (SERPER_API_KEY)
...
Location: `/home/josh/Josh-AI/tools/serper/serper_search.py`
